//go:generate protoc -I=proto -I=$GOPATH/src -I=$GOPATH/src/github.com/Dharitri-org/protobuf/protobuf  --gogoslick_out=. transaction.proto
package transaction

import (
	"math/big"

	"github.com/Dharitri-org/me-kalyan/core"
	"github.com/Dharitri-org/me-kalyan/core/check"
	"github.com/Dharitri-org/me-kalyan/data"
)
